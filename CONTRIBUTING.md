...
Do not rewrite existing authorship or remove contributor credit when moving or
refactoring collaborative code. Use `Co-authored-by` trailers when a new commit
contains substantial work from another person.
